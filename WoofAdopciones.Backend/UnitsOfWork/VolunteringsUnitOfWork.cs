...
{
    public class VolunteringsUnitOfWork : GenericUnitOfWork<RequestVolunteering>, IAVolunteringsUnitOfWork
    {
        private readonly IAVolunteringsRepository _adoptionsRepository;

        public VolunteringsUnitOfWork(IGenericRepository<RequestVolunteering> repository, IAVolunteringsRepository adoptionsRepository) : base(repository)
        {
